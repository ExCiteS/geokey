...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field projects on 'Location'
        m2m_table_name = db.shorten_name(u'contributions_location_projects')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('location', models.ForeignKey(orm[u'contributions.location'], null=False)),
            ('project', models.ForeignKey(orm[u'projects.project'], null=False))
        ))
        db.create_unique(m2m_table_name, ['location_id', 'project_id'])
        ...
        db.create_table(u'contributions_observation', (
            ...
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('feature', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contributions.Location'])),
            ('status', self.gf('django.db.models.fields.CharField')(default='active', max_length=20)),
        ...
        db.create_table(u'contributions_comment', (
            ...
            ('respondsto', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contributions.Comment'], null=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default='active', max_length=20)),
        ))
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field projects on 'Location'
        db.delete_table(db.shorten_name(u'contributions_location_projects'))
    ...
    models = {
        ...
        u'contributions.comment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'respondsto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contributions.Comment']", 'null': 'True'}),
        ...
        u'contributions.observation': {
            ...
            'feature': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contributions.Location']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
