...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MediaFile.status'
        db.add_column(u'contributions_mediafile', 'status',
                      self.gf('django.db.models.fields.CharField')(default='active', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MediaFile.status'
        db.delete_column(u'contributions_mediafile', 'status')
