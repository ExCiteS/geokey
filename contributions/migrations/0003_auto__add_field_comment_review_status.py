...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comment.review_status'
        db.add_column(u'contributions_comment', 'review_status',
    ...
    models = {
        ...
        'contributions.comment': {
            ...
            'review_status': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '20'}),
