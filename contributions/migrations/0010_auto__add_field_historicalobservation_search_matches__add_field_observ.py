...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HistoricalObservation.search_matches'
        db.add_column(u'contributions_historicalobservation', 'search_matches',
                      self.gf('django.db.models.fields.TextField')(default='unset'),
                      keep_default=False)

        # Adding field 'Observation.search_matches'
        db.add_column(u'contributions_observation', 'search_matches',
                      self.gf('django.db.models.fields.TextField')(default='unset'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HistoricalObservation.search_matches'
        db.delete_column(u'contributions_historicalobservation', 'search_matches')

        # Deleting field 'Observation.search_matches'
        db.delete_column(u'contributions_observation', 'search_matches')
