...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ObservationType.created_at'
        db.add_column(u'observationtypes_observationtype', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 9, 17, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ObservationType.created_at'
        db.delete_column(u'observationtypes_observationtype', 'created_at')
