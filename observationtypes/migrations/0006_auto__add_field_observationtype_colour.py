...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ObservationType.colour'
        db.add_column(u'observationtypes_observationtype', 'colour',
                      self.gf('django.db.models.fields.TextField')(default='#0033ff'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ObservationType.colour'
        db.delete_column(u'observationtypes_observationtype', 'colour')
