...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ObservationType.symbol'
        db.add_column(u'observationtypes_observationtype', 'symbol',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ObservationType.symbol'
        db.delete_column(u'observationtypes_observationtype', 'symbol')
