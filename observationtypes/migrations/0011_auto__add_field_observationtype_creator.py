...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ObservationType.creator'
        db.add_column(u'observationtypes_observationtype', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['users.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ObservationType.creator'
        db.delete_column(u'observationtypes_observationtype', 'creator_id')
