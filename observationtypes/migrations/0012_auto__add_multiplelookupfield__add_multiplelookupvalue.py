...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'observationtypes_multiplelookupfield', (
        ...
        db.send_create_signal(u'observationtypes', ['MultipleLookupField'])

        # Adding model 'MultipleLookupValue'
        db.create_table(u'observationtypes_multiplelookupvalue', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('field', self.gf('django.db.models.fields.related.ForeignKey')(related_name='lookupvalues', to=orm['observationtypes.MultipleLookupField'])),
            ('status', self.gf('django.db.models.fields.CharField')(default='active', max_length=20)),
        ))
        db.send_create_signal(u'observationtypes', ['MultipleLookupValue'])


    def backwards(self, orm):
        # Deleting model 'MultipleLookupField'
        db.delete_table(u'observationtypes_multiplelookupfield')

        # Deleting model 'MultipleLookupValue'
        db.delete_table(u'observationtypes_multiplelookupvalue')
    ...
    models = {
        ...
        u'observationtypes.multiplelookupfield': {
            'Meta': {'object_name': 'MultipleLookupField', '_ormbases': [u'observationtypes.Field']},
            u'field_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['observationtypes.Field']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'observationtypes.multiplelookupvalue': {
            'Meta': {'object_name': 'MultipleLookupValue'},
            'field': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'lookupvalues'", 'to': u"orm['observationtypes.MultipleLookupField']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '20'})
        },
