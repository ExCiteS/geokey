...
def update(request, project_id):
	if request.method == "PUT":
		project = authorization.projects.update(request.user, project_id, json.loads(request.body))
...
def add_user_to_group(request, project_id, group_id):
	group = authorization.projects.add_user_to_group(request.user, project_id, group_id, json.loads(request.body))
...
def remove_user_from_group(request, project_id, group_id, user_id):
	authorization.projects.remove_user_from_group(request.user, project_id, group_id, user_id)
