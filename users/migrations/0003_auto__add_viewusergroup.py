...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ViewUserGroup'
        db.create_table(u'users_viewusergroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('usergroup', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.UserGroup'])),
            ('view', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dataviews.View'])),
        ...
        db.send_create_signal(u'users', ['ViewUserGroup'])


    def backwards(self, orm):
        # Deleting model 'ViewUserGroup'
        db.delete_table(u'users_viewusergroup')
    ...
    models = {
        ...
        u'users.viewusergroup': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'usergroup': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.UserGroup']"}),
            'view': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dataviews.View']"})
        }
    }
