...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserGroup.can_edit'
        db.delete_column(u'users_usergroup', 'can_edit')

        # Adding field 'UserGroup.can_contribute'
        db.add_column(u'users_usergroup', 'can_contribute',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserGroup.can_edit'
        db.add_column(u'users_usergroup', 'can_edit',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'UserGroup.can_contribute'
        db.delete_column(u'users_usergroup', 'can_contribute')
