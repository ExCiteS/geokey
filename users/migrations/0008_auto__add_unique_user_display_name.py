...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'User', fields ['display_name']
        db.create_unique(u'users_user', ['display_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'User', fields ['display_name']
        db.delete_unique(u'users_user', ['display_name'])
