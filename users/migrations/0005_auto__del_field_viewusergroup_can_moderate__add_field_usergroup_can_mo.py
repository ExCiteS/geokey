...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ViewUserGroup.can_moderate'
        db.delete_column(u'users_viewusergroup', 'can_moderate')

        # Adding field 'UserGroup.can_moderate'
        db.add_column(u'users_usergroup', 'can_moderate',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ViewUserGroup.can_moderate'
        db.add_column(u'users_viewusergroup', 'can_moderate',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'UserGroup.can_moderate'
        db.delete_column(u'users_usergroup', 'can_moderate')
