...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rule.min_date'
        db.add_column(u'dataviews_rule', 'min_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Rule.max_date'
        db.add_column(u'dataviews_rule', 'max_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Rule.min_date'
        db.delete_column(u'dataviews_rule', 'min_date')

        # Deleting field 'Rule.max_date'
        db.delete_column(u'dataviews_rule', 'max_date')
    ...
    models = {
        ...
        u'projects.project': {
            ...
            'all_contrib_isprivate': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.User']"}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
