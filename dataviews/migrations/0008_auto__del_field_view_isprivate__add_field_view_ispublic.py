...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'View.isprivate'
        db.delete_column(u'dataviews_view', 'isprivate')

        # Adding field 'View.ispublic'
        db.add_column(u'dataviews_view', 'ispublic',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'View.isprivate'
        db.add_column(u'dataviews_view', 'isprivate',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'View.ispublic'
        db.delete_column(u'dataviews_view', 'ispublic')
