...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Rule'
        db.create_table(u'dataviews_rule', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('view', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rules', to=orm['dataviews.View'])),
            ('observation_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['observationtypes.ObservationType'])),
        ))
        db.send_create_signal(u'dataviews', ['Rule'])


    def backwards(self, orm):
        # Deleting model 'Rule'
        db.delete_table(u'dataviews_rule')
