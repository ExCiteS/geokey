...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'projects_project', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User']))

    def backwards(self, orm):

        # Changing field 'Project.description'
        db.alter_column(u'projects_project', 'description', self.gf('django.db.models.fields.TextField')(default=None))

        # Changing field 'Project.creator'
        db.alter_column(u'projects_project', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
