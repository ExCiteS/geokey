...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.all_contrib_isprivate'
        db.delete_column(u'projects_project', 'all_contrib_isprivate')


    def backwards(self, orm):
        # Adding field 'Project.all_contrib_isprivate'
        db.add_column(u'projects_project', 'all_contrib_isprivate',
