...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.everyonecontributes'
        db.delete_column(u'projects_project', 'everyonecontributes')


    def backwards(self, orm):
        # Adding field 'Project.everyonecontributes'
        db.add_column(u'projects_project', 'everyonecontributes',
