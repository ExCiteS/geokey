...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.everyone_contributes'
        db.add_column(u'projects_project', 'everyone_contributes',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.everyone_contributes'
        db.delete_column(u'projects_project', 'everyone_contributes')
