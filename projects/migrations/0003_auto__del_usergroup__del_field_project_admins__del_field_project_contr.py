...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Project.admins'
        db.delete_column(u'projects_project', 'admins_id')

        # Deleting field 'Project.contributors'
        db.delete_column(u'projects_project', 'contributors_id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Project.admins'
        raise RuntimeError("Cannot reverse this migration. 'Project.admins' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Project.admins'
        db.add_column(u'projects_project', 'admins',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='admingroup', unique=True, to=orm['projects.UserGroup']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Project.contributors'
        raise RuntimeError("Cannot reverse this migration. 'Project.contributors' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Project.contributors'
        db.add_column(u'projects_project', 'contributors',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='contributorgroup', unique=True, to=orm['projects.UserGroup']),
                      keep_default=False)
