...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Application.client'
        db.alter_column(u'applications_application', 'client_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oauth2.Client'], null=True))

    def backwards(self, orm):

        # Changing field 'Application.client'
        db.alter_column(u'applications_application', 'client_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['oauth2.Client']))
    ...
    models = {
        ...
        u'oauth2.client': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "'d4e252f7cf354f4ccc45'", 'max_length': '255'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "'dd61d7c561d689ae5b2987b1f90cf643b006fc2d'", 'max_length': '255'}),
