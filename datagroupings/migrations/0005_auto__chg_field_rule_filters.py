...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Rule.filters'
        db.alter_column(u'dataviews_rule', 'filters', self.gf(u'django_hstore.fields.DictionaryField')(null=True))

    def backwards(self, orm):

        # Changing field 'Rule.filters'
        db.alter_column(u'dataviews_rule', 'filters', self.gf(u'django_hstore.fields.DictionaryField')(default=None))
