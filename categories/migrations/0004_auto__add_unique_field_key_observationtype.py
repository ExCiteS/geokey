...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Field', fields ['key', 'observationtype']
        db.create_unique(u'observationtypes_field', ['key', 'observationtype_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Field', fields ['key', 'observationtype']
        db.delete_unique(u'observationtypes_field', ['key', 'observationtype_id'])
