...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Field.key'
        db.alter_column(u'categories_field', 'key', self.gf('django.db.models.fields.CharField')(max_length=103))

    def backwards(self, orm):

        # Changing field 'Field.key'
        db.alter_column(u'categories_field', 'key', self.gf('django.db.models.fields.CharField')(max_length=30))
    ...
    models = {
        ...
        u'categories.field': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'max_length': '103'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
