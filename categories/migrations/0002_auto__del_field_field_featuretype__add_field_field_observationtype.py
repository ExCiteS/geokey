...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Field.featuretype'
        db.delete_column(u'observationtypes_field', 'featuretype_id')

        # Adding field 'Field.observationtype'
        db.add_column(u'observationtypes_field', 'observationtype',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['observationtypes.ObservationType']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Field.featuretype'
        db.add_column(u'observationtypes_field', 'featuretype',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['observationtypes.ObservationType']),
                      keep_default=False)

        # Deleting field 'Field.observationtype'
        db.delete_column(u'observationtypes_field', 'observationtype_id')
