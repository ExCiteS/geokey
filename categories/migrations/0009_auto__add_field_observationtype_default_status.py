...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ObservationType.default_status'
        db.add_column(u'observationtypes_observationtype', 'default_status',
                      self.gf('django.db.models.fields.CharField')(default='pending', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ObservationType.default_status'
        db.delete_column(u'observationtypes_observationtype', 'default_status')
